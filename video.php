...
<script src="https://cdn.jsdelivr.net/npm/ovenlivekit@latest/dist/OvenLiveKit.min.js"></script>
    <script>
        ...
        let id = <?php echo $id; ?>;
        // let linkToStream = 'wss://video.darts28.ru:3334/vidme/' + id + '?direction=send&transport=tcp';
        ...
        ovenLivekit.getUserMedia({
            ...
            ovenLivekit.startStreaming('wss://video.darts28.ru:3334/vidme/' + id + '?direction=send&transport=tcp')
        });
